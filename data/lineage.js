...
// ==========================================
const ll_chaoyang = [
  { id: "ll_a16", gen: 16, father: "c_5c193f48", name: "朝陽", pinyin: "Chaoyang", gender: "m", birthPlace: "p_yongan", residencePlace: "p_lilang", note: "叔九公. 生于惠州永安下義龍舟寨 自康熙年間 始來新安李朗. 偕祖妣文太李氏開基五業. Often misread as 朝鴻 or 朝湧.", confidence: "med" },
...
window.LINEAGE = {
  ...
  persons: [
    ...
    { id: "a01",  gen: 1, name: "江八郎", pinyin: "Baliang", style: "字文明", gender: "m", relation: "始祖 Founding ancestor", birthPlace: "p_ninghua", residencePlace: "p_shanghang", bio: "由寧化石壁移來上杭三坪鄉開基五業。所生三大房：長萬里、次萬載、三萬頃。", confidence: "med" },
    { id: "a01w", gen: 1, name: "張一娘", pinyin: "Madam Zhang", gender: "f", spouseOf: "a01", burialPlace: "p_shanghang", note: "合塋福建上杭三坪鄉.", confidence: "med" },

    { id: "a02b", gen: 2, father: "a01", name: "江萬里", pinyin: "Wanli", style: "諡文忠 · 名臨 · 號古心", gender: "m", relation: "伯祖 (granduncle)", bio: "登宋咸淳進士、端宗狀元，累官尚書、入丞相，薨，追封大傅益國公。所生三子：長錫、次鑄、三鏜。", note: "pt1 p.17 and the master chart on p.1 both give 萬里 the 號 古心 and the Song civil honours; this file previously carried 萬載's details here and vice versa. Corrected 2026-08-20.", confidence: "med" },
    { id: "a02c", gen: 2, father: "a01", name: "江萬載", pinyin: "Wanzai", style: "諡武肅侯 · 名億 · 號古山", gender: "m", relation: "伯祖 (granduncle)", bio: "官授錦衣衛指揮使，亦授禮部尚書，攝行中軍事，扶宋帝昺入閩。所生二子：長鑰、次鈕。", note: "The book writes 萬載, not 萬戴 (pt1 p.17 and the p.1 chart agree). Details were previously swapped with 萬里. Corrected 2026-08-20.", confidence: "med" },
    ...
    { id: "a02c_c2", gen: 3, father: "a02c", name: "鈕", pinyin: "Niu", gender: "m", relation: "次子", note: "pt1 p.17 reads 鈕 (金 + 丑); previously transcribed 鉦.", confidence: "low" },
    { id: "a03", gen: 3, father: "a02", name: "十八郎", pinyin: "Shibalang", formalName: "鎬", gender: "m", relation: "三世祖 (direct line · 長子)", bio: "所生三子：長百八郎、次百三郎、三四六郎。", note: "pt1 p.19「世祖十八郎。妣邱氏十六娘。」and p.18 head the five gen-3 brothers with 八郎妣邱氏; the p.1 master chart names him 鎬十八郎 and drops the descent line from him to 百八郎/百三郎/四六郎. This file previously had 念三郎 on the direct line — 念三郎 is the 三叔祖. Corrected 2026-08-20, confirmed by the family. 公塋在上杭三坪源裏，地名真武踏龜形；妣塋在上杭三坪坭洋屋後，烏鴉曬翼形。", burialPlace: "p_shanghang", confidence: "med" },
    { id: "a03w", gen: 3, name: "邱氏十六娘", pinyin: "Madam Qiu", gender: "f", spouseOf: "a03", note: "pt1 pp.18–19. 塋在上杭三坪坭洋屋後，烏鴉曬翼形。", confidence: "low" },
    { id: "a03e", gen: 3, father: "a02", name: "念三郎", pinyin: "Niansanlang", gender: "m", relation: "三世 · 三叔祖", note: "pt1 p.19「三叔祖念三郎。妣張氏七娘。」Held the direct-line slot in this file until 2026-08-20; the direct line is 十八郎 (a03).", confidence: "low" },
    { id: "a03e_w", gen: 3, name: "張氏七娘", pinyin: "Madam Zhang", gender: "f", spouseOf: "a03e", confidence: "low" },
    { id: "a03b", gen: 3, father: "a02", name: "念一郎", pinyin: "Nianyilang", gender: "m", relation: "三世 · 四叔祖", confidence: "low" },
    { id: "a03b_w", gen: 3, name: "劉氏一娘", pinyin: "Madam Liu", gender: "f", spouseOf: "a03b", note: "pt1 p.19.", confidence: "low" },
    { id: "a03c", gen: 3, father: "a02", name: "念二郎", pinyin: "Nian'erlang", formalName: "鋼", gender: "m", relation: "三世 · 二叔祖", note: "The p.1 chart writes him 鋼念二郎. pt1 p.18 gives his wife twice and differently — 蕭氏六娘 in the brother list, 薛氏 in his own entry — and the book itself flags the two accounts as conflicting: 「按上二說各有牴牾…並存以待參考」.", confidence: "low" },
    ...
    { id: "a03d", gen: 3, father: "a02", name: "念五郎", pinyin: "Nianwulang", gender: "m", relation: "三世 · 五叔祖", note: "pt1 p.19「五叔祖念五郎。妣李氏三娘。」考三世祖兄弟五人：長子世居上杭三坪鄉，二子移居永定縣武藝坪，三子移于大埔，四子移于埔藍樹窖，五子移居程鄉鷓鴣坑 — 自此江氏分為五大支。", confidence: "low" },
    { id: "a03d_w", gen: 3, name: "李氏三娘", pinyin: "Madam Li", gender: "f", spouseOf: "a03d", confidence: "low" },
    ...
    { id: "a13", gen: 13, father: "a12", name: "榮川公", pinyin: "Rongchuan", style: "字以賢", gender: "m", relation: "十三世祖 (direct line · 三子)",
      note: "pt1 p.27 names him outright:「十三世祖榮川公字以賢」— he is 元珠公's third son. p.26 lists the four brothers 長繼川、次懷川、三榮川、四華川, and p.27 gives each his 字: 繼川=榮祖 (伯祖), 懷川=榮祥 (仲祖), 華川=榮華 (叔祖). This entry was an unresolved placeholder with four candidates until 2026-08-20.",
      burialPlace: "p_yongan", confidence: "med" },
    { id: "c_1f98f71e", gen: 13, father: "a12", name: "繼川公", pinyin: "Jichuan", style: "字榮祖", gender: "m", relation: "十三世 · 伯祖 (長子)", note: "妣劉氏。生二子：長道遠、次道… (pt1 p.27).", confidence: "low" },
    { id: "c_1f98f71e_w", gen: 13, name: "劉氏", pinyin: "Madam Liu", gender: "f", spouseOf: "c_1f98f71e", confidence: "low" },
    { id: "c_451fa807", gen: 13, father: "a12", name: "懷川公", pinyin: "Huaichuan", style: "字榮祥", gender: "m", relation: "十三世 · 仲祖 (次子)", note: "妣詹氏。移居廣寧古英坑 (pt1 p.27).", confidence: "low" },
    { id: "c_451fa807_w", gen: 13, name: "詹氏", pinyin: "Madam Zhan", gender: "f", spouseOf: "c_451fa807", confidence: "low" },
    { id: "c_80bf1a96", gen: 13, father: "a12", name: "華川公", pinyin: "Huachuan", style: "字榮華", gender: "m", relation: "十三世 · 叔祖 (四子)", note: "妣周氏。生二子：長道俊、次道明 (pt1 p.27).", confidence: "low" },
    { id: "c_80bf1a96_w", gen: 13, name: "周氏", pinyin: "Madam Zhou", gender: "f", spouseOf: "c_80bf1a96", confidence: "low" },
    { id: "c_80bf1a96_c1", gen: 14, father: "c_80bf1a96", name: "道俊公", pinyin: "Daojun", gender: "m", relation: "長子", note: "生下源言 (pt1 p.27).", confidence: "low" },
    { id: "c_80bf1a96_c2", gen: 14, father: "c_80bf1a96", name: "道明公", pinyin: "Daoming", gender: "m", relation: "次子", note: "生下松保 (pt1 p.27).", confidence: "low" },
    { id: "c_80bf1a96_g1", gen: 15, father: "c_80bf1a96_c1", name: "源言", pinyin: "Yuanyan", gender: "m", note: "妻鄺氏，生下成瑞、成珍、成琭 (pt1 p.27).", confidence: "low" },
    { id: "c_80bf1a96_g1w", gen: 15, name: "鄺氏", pinyin: "Madam Kwong", gender: "f", spouseOf: "c_80bf1a96_g1", confidence: "low" },
    { id: "c_80bf1a96_g2", gen: 15, father: "c_80bf1a96_c2", name: "松保", pinyin: "Songbao", gender: "m", confidence: "low" },
    { id: "c_80bf1a96_h1", gen: 16, father: "c_80bf1a96_g1", name: "成瑞", pinyin: "Chengrui", gender: "m", confidence: "low" },
    { id: "c_80bf1a96_h2", gen: 16, father: "c_80bf1a96_g1", name: "成珍", pinyin: "Chengzhen", gender: "m", confidence: "low" },
    { id: "c_80bf1a96_h3", gen: 16, father: "c_80bf1a96_g1", name: "成琭", pinyin: "Chenglu", gender: "m", confidence: "low" },
    ...
    { id: "a15", gen: 15, father: "a14", name: "日輝公", pinyin: "Rihui", gender: "m", relation: "十五世祖 (direct line)", confidence: "med",
      note: "道通公之長房 (pt1 p.29)。己未生，妣黃氏，所生四子：長潮源、次潮海、三潮浩、四潮湖 — the 潮 generation, whose line continues through 文和 to 世和/世錦/世宏 (p.30) and is NOT the Sabah line. This file previously hung 朝纓 under him." },
    { id: "a15_riming", gen: 15, father: "a14", name: "日明公", pinyin: "Riming", gender: "m", relation: "十五世", confidence: "med",
      note: "⚠ pt1 p.29 names 道通公之九大房 as 日輝、日煌、日焕、日燿、日煒、日炫、日標、日亮、日開 — 日明 is not among them, and 朝陽, whom this file once gave him, is now recorded as 日標之子。He may be an alternate reading of one of the nine. To verify." },
    { id: "c_5c193f48", gen: 15, father: "a14", name: "日標", pinyin: "Ribiao", gender: "m", relation: "十五世", note: "七房。朝纓公、朝陽公之父，家族確認 2026-08-20。pt1 p.29「所生九大房」。Id matches the row entered live 2026-08-16.", confidence: "low" },
    { id: "c_9b40e159", gen: 15, father: "a14", name: "日煌", pinyin: "Rihuang", gender: "m", relation: "十五世", note: "次房。pt1 p.29「所生九大房」。Id matches the row entered live 2026-08-16.", confidence: "low" },
    { id: "c_a2884a69", gen: 15, father: "a14", name: "日焕", pinyin: "Rihuan", gender: "m", relation: "十五世", note: "三房。pt1 p.29「所生九大房」。Id matches the row entered live 2026-08-16.", confidence: "low" },
    { id: "c_c8f15661", gen: 15, father: "a14", name: "日耀", pinyin: "Riyao", gender: "m", relation: "十五世", note: "四房。pt1 p.29「所生九大房」。Id matches the row entered live 2026-08-16.", confidence: "low" },
    { id: "c_e25cc1ec", gen: 15, father: "a14", name: "日炜", pinyin: "Riwei", gender: "m", relation: "十五世", note: "五房。pt1 p.29「所生九大房」。Id matches the row entered live 2026-08-16.", confidence: "low" },
    { id: "c_e6d1e759", gen: 15, father: "a14", name: "日炫", pinyin: "Rixuan", gender: "m", relation: "十五世", note: "六房。pt1 p.29「所生九大房」。Id matches the row entered live 2026-08-16.", confidence: "low" },
    { id: "c_8426f2c9", gen: 15, father: "a14", name: "日亮", pinyin: "Riliang", gender: "m", relation: "十五世", note: "八房。pt1 p.29「所生九大房」。Id matches the row entered live 2026-08-16.", confidence: "low" },
    { id: "c_ec33142c", gen: 15, father: "a14", name: "日开", pinyin: "Rikai", gender: "m", relation: "十五世", note: "九房。pt1 p.29「所生九大房」。Id matches the row entered live 2026-08-16.", confidence: "low" },
    { id: "c_b966a0af", gen: 16, father: "c_5c193f48", name: "朝滔", pinyin: "Chaotao", gender: "m", relation: "十六世", note: "日標公之子，朝纓公之兄弟。舊稿曾將譜表之朝滔讀作朝纓，實為二人。", confidence: "low" },
    { id: "c_ed1f9544", gen: 16, father: "c_5c193f48", name: "朝浚", pinyin: "Chaojun", gender: "m", relation: "十六世", note: "日標公之子，朝纓公之兄弟。舊稿曾將譜表之朝滔讀作朝纓，實為二人。", confidence: "low" },
    { id: "c_6b8dccf8", gen: 16, father: "c_5c193f48", name: "朝泳", pinyin: "Chaoyong", gender: "m", relation: "十六世", note: "日標公之子，朝纓公之兄弟。舊稿曾將譜表之朝滔讀作朝纓，實為二人。", confidence: "low" },
    { id: "c_d30ae04c", gen: 16, father: "c_5c193f48", name: "朝锡", pinyin: "Chaoxi", gender: "m", relation: "十六世", note: "日標公之子，朝纓公之兄弟。舊稿曾將譜表之朝滔讀作朝纓，實為二人。", confidence: "low" },
    { id: "c_394e869e", gen: 16, father: "c_5c193f48", name: "朝沔", pinyin: "Chaomian", gender: "m", relation: "十六世", note: "日標公之子，朝纓公之兄弟。舊稿曾將譜表之朝滔讀作朝纓，實為二人。", confidence: "low" },
    { id: "c_afc77956", gen: 16, father: "c_5c193f48", name: "朝涥", pinyin: "Chaoheng", gender: "m", relation: "十六世", note: "日標公之子，朝纓公之兄弟。舊稿曾將譜表之朝滔讀作朝纓，實為二人。", confidence: "low" },
    { id: "a16", gen: 16, father: "c_5c193f48", name: "江朝纓公", pinyin: "Chaoying", style: "字 成祥", gender: "m", relation: "十六世祖 (direct line)", confidence: "med",

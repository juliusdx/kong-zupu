...
(function () {
  const dict = {
    en: {
      ...
      auth_signout_note: "To come back you will need a new sign-in link emailed to you.",
      auth_state_ok: "\u2713 Approved \u2014 you can see the family's details.",
      auth_state_pending: "\u23f3 Waiting for a reviewer to approve you.",
      lang_switch: "中文",
      ...
      r_script_warn: "Simplified characters — the book is traditional. Suggested: ",
      r_script_note: "Approving keeps it exactly as submitted. For a living relative, simplified may well be correct.",
    ...
    zh: {
      ...
      auth_signout: "登出",
      auth_signout_note: "登出後須重新以電郵取得登入連結，才能再次進入。",
      auth_state_ok: "\u2713 已通過審核 \u2014 可查看家族詳情。",
      auth_state_pending: "\u23f3 正在等待家族審核。",
      lang_switch: "EN",
      ...
      r_script_warn: "含簡體字 — 族譜原書為繁體。建議：",
      r_script_note: "核准將照原樣保留。若為在世親屬，簡體字可能才是正確的寫法。",

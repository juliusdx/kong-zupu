...
(function () {
  const dict = {
    en: {
      ...
      src_h: "文獻 · Original sources",
      src_intro: "Scans of the original handwritten 族譜 and related documents. These are <b>family-only</b> — sign in with your family account to view them.",
      src_locked: "🔒 Family-only — sign in to view the scans.",
      src_signin: "Sign in to view",
      src_view: "閱覽 View",
      src_pages: " pp",
    ...
    zh: {
      ...
      src_h: "文獻 · 原始資料",
      src_intro: "原手抄本《族譜》及相關文獻掃描。此為<b>家族限定</b> — 請以家族帳號登入後查閱。",
      src_locked: "🔒 家族限定 — 登入後查閱掃描本。",
      src_signin: "登入查閱",
      src_view: "閱覽",
      src_pages: " 頁",

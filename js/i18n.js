...
(function () {
  const dict = {
    en: {
      ...
      visits_label: "visits",
      pn_zh: "為保障家族成員隱私，如需查閱聯絡資料、相片及其他私人資訊，請以 Google 帳號或電郵地址快速建立帳號。",
      pn_en: "For maximum privacy to members of the family, creating a quick account via Google or providing an email address is required to access contacts, photos and other information.",
      pn_signin: "Sign in / 登入",
      ...
      mt_grave: "墓 Graves", mt_hall: "祀堂 Ancestral halls",
      ...
      f_opt_edit: "Correct / enrich an existing person", f_opt_add_place: "Add / fix a location (祀堂 / grave)",
      ...
      f_section_loc: "Location (for 祀堂 / grave / residence pins)",
      f_placetype: "Place type", pt_hall: "祀堂 Ancestral hall", pt_grave: "墓 Grave",
      ...
      f_pin_person_hint: "Their current home / where they are — shows as a named dot on the map. Not the formal 祀堂/grave place.",
      ...
      ab_p2: "Over the centuries the family migrated 汀州永定 (烏垛坪 桂花樹下) → <b>長樂 (today 五華)</b> around 1569 → 永安 → <b>新安 李朗 (today Shenzhen)</b>; and one line emigrated to British North Borneo — <b>古達 Kudat, 山打根 Sandakan, 吧巴 Papar</b> in Sabah, Malaysia. The seed data is transcribed from the full handwritten <i>Kong Family Book</i> (pt 1 &amp; 2), covering generations 1–26 of the direct line.",
      ab_h_poem: "字輩 · Generational names",
      ab_h_help: "How to help",
      ab_help: "Most early entries are marked <span class=\"badge low\">needs verification</span> — they are best-effort readings of old handwriting. If you recognise an ancestor, can add a photo, fix a date, add your own branch, or pin the exact GPS of a 祀堂 (ancestral hall) or grave, please use the <b>貢獻 Contribute</b> tab. Every change is reviewed before it goes live.",
    ...
    zh: {
      ...
      pn_zh: "為保障家族成員隱私，如需查閱聯絡資料、相片及其他私人資訊，請以 Google 帳號或電郵地址快速建立帳號。",
      pn_en: "For maximum privacy to members of the family, creating a quick account via Google or providing an email address is required to access contacts, photos and other information.",
      pn_signin: "登入 / Sign in",
      tab_tree: "族譜", tab_map: "地圖", tab_contribute: "貢獻",
      tab_review: "審核", tab_about: "關於", tab_sources: "文獻",

      src_h: "文獻 · 典藏",
      src_intro: "家族第一手文獻的展覽——原手抄本《族譜》及其釋文，以「原件—詮釋」並陳。導覽文字人人可讀；原件揃描為<b>家族限定</b>，登入後即可於閱覽器開啟。",
      src_locked: "🔒 原件揃描為家族限定 — 登入後開啟。以下展覽說明人人可讀。",
      src_signin: "登入",
      src_view: "閱覽原件",
      src_read: "閱覽釋文 ↗",
      src_pages: " 頁",
      ...
      pf_open: "✍️ 協助校讀",
      pf_title: "一起校讀",
      pf_help: "對照揃描原件與文字，發現錯處請直接修改——哪怕一個字也好。不確定？可填上最接近的猜測或備註。每筆修改都會經編輯審核後才保存。",
      pf_page: "第",
      pf_of: "／共",
      ...
      mt_origin: "祖籍（閂／粵）", mt_residence: "遷居",
      mt_grave: "墳墓", mt_hall: "祀堂",
      mt_church: "教會墳場", mt_diaspora: "沙巴僕居",
      mt_person: "親人",
      ...
      f_pin_person_hint: "他／她目前的居所或所在地 — 會以姓名標示在地圖上。並非祀堂／墳墓等正式地點。",
      ...
      d_seam_badge: "※ 世系接縮",
      d_seam: "位於1825合譜世系接縮 — 此處族書「世」與本站世代編號相差約一代。詳見「關於」。",
      seam_tip: "世系編號接縮（1825合譜）— 詳見「關於」頁",
      ...
      ab_p2: "歷代遷徙：汀州永定（烏垛坪 桂花樹下）→ 約1569年遷<b>長樂（今五華）</b>→ 永安 → <b>新安李朗（今深圳）</b>；其中一支遠渡英屬北婆羅洲 — 馬來西亞沙巴的<b>古達、山打根、吧巴</b>。種子資料轉錄自手抄本《江氏族譜》（上、下冊），涵蓋直系第 1–26 世。",
      ab_h_poem: "字輩",
      ab_h_help: "如何協助",
      ab_help: "多數早期條目標示為<span class=\"badge low\">待考證</span> — 皆為對舊手稿的盡力辨讀。若您認得某位祖先、能補上相片、訂正日期、新增自己的支系，或標出<b>祀堂</b>或墳墓的精確座標，請使用<b>貢獻</b>頁。所有更動經審核後方會上線。",
      ab_h_privacy: "私隱",
      ab_privacy: "世系與祖地公開可見。<i>在世</i>成員的相片與細節僅向已登入的家族成員顯示。聯絡方式為私密。未成年者預設隱藏，任何人亦可要求移除。",
      ab_h_tech: "技術",
      ab_tech: "靜態網站（可免費託托於 GitHub Pages）＋ 可選用的 Supabase 後端，處理帳戶、上載與審核。詳見儲存庫中的 <code>README.md</code> 與 <code>supabase/schema.sql</code>。",
      ab_h_seam: "關於世代編號（1825 合譜接縮）",
      ab_seam: "1825年（道光五年）家族合譜，將較淺的《<b>新安老族譜</b>》（僅上溯約四代，以賴氏／貴七公為始祖）接上更早、直達始祖<b>江八郎</b>的世系。兩譜相接處在<b>起瀏公（第18世）</b>→其五大房<b>（第20世）</b>一帶留下<b>接縮</b>，合併時吸收了一代，故此處族書印刷的「世」與本站世代編號相差約一代。本譜採一致編號並依父子關係排版，故跳號不影響族譜結構。受影響的祖先卡片標有 <span class=\"seam-mark\">※</span>。"
    }
  };
